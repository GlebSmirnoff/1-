...
class RegisterSerializer(serializers.ModelSerializer):
    ...
    def create(self, validated_data):
        user = User.objects.create_user(
            ...
            is_active=False,
            is_approved=(validated_data['account_type'] == 'buyer')
        )
        return user
...
class UserSerializer(serializers.ModelSerializer):
    class Meta:
        model = User
        fields = ['id', 'email', 'full_name', 'account_type', 'phone', 'created_at']
...
class RegisterByPhoneSerializer(serializers.Serializer):
    ...
    def create(self, validated_data):
        # use get_random_string for a pseudo‑random password
